            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    ...
                    <div class="ibox-tools">
                        ...
                        <button class="btn btn-primary btn-xs print_all_btn" onclick="print_multi_invoice('{$_url}')"><span><i class="fa fa-print"></i></span>Print All</button>
                ...
                <div class="ibox-content">
                        ...
                        <form class="form-horizontal" id = "invoice_list_filter" method="post" action="">
                            ...
                            <div class="col-sm-12 filter-box">
                                <div class="input-group col-sm-4 ">
                                    <label for="fromDate" class="col-sm-4  pr-15 control-label">{$_L['From Date']}</label>
                                    <div class="col-sm-8 ">
                                        <input type="text" class="form-control" id="fromDate" name="fromDateFilter" datepicker
                                                    data-date-format="yyyy-mm-dd" data-auto-close="true" onchange="changeFromDate(this)" value="{$filter_from_date}">
                                    </div>
                                </div>

                                <div class="input-group col-sm-4 ">
                                    <label for="toDate" class="col-sm-4  pr-15 control-label">{$_L['To Date']}</label>
                                    <div class="col-sm-8 ">
                                        <input type="text" class="form-control" id="toDate" name="toDateFilter" datepicker
                                                    data-date-format="yyyy-mm-dd" data-auto-close="true" onchange="changeToDate(this)" value="{$filter_to_date}">
                                    </div>
                                </div>
                                <div class=" input-group col-sm-4" style="text-align:center; height:34px;">
                                    ...
                                    {if $filter_unpaid_checked == "checked"}
                    ...
                    <table class="table table-bordered table-hover sys_table footable" {if $view_type == 'filter'} data-filter="#foo_filter" data-page-size="50" {/if}>
                        ...
                        {foreach $d as $ds}
                            <tr>
                                <td><input type="checkbox" name="sub_checkbox" class="sub_checkbox" id="sub_checkbox_{$ds['id']}"></td>
