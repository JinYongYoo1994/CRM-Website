            ...
            <tr>
                ...
                <td rowspan="5" style="border:none; text-align:center; vertical-align:bottom; text-align:right" width="31%">
                            <img style="margin-bottom:-23px; margin-right:-4px" src="https://chart.googleapis.com/chart?chs=100x100&cht=qr&chl=<?php echo APP_URL; ?>?ng=client/iview/<?php
                                                                                                                                            echo $d['id'];
                                                                                                                                            ?>/token_<?php echo $d['vtoken']; ?>%2F&choe=UTF-8" title="Link to print invoice" width="100" />
...
<!--            <th align="right">--><?php //echo $_L['Qty']; ?><!--</th>-->
        ...
        <?php
            ...
            <tr>
                ...
                <td class="total-value balance" style="background:white"><div class="due"><?php echo ib_money_format($d['total'],$config,$d['currency_symbol']); ?></div></td>
            </tr>
        <?php
        }
        ?>
